      ...
      <Table celled structured>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell rowSpan="2" colSpan="3">Аудиторні заняття</Table.HeaderCell>
            <Table.HeaderCell rowSpan="2" colSpan="8">Контр.заходи</Table.HeaderCell>
            ...
            <Table.HeaderCell rowSpan="2" colSpan="12">РНН</Table.HeaderCell>
        ...
        <Table.Body>
          {disciplines.map((discipline, i) => <K3TableRow {...discipline} num={i + 1} key={i} />)}
        </Table.Body>
      </Table>
    );
  }

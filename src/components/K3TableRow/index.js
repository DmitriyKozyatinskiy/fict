...
const K3TableRow =
  ({
    ...
    const courseProjectsLoad = getCourseProjectsLoad({ courseProjects, bStudents, bkStudents });
    const courseWorksLoad = getCourseWorksLoad({ courseWorks, bStudents, bkStudents });
